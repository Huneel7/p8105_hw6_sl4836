...
```
  ...
  It is to be observed that the distribution of $log(\beta_{0} * \beta_{1})$ is approximately normally distributed with mean of 2.01 and standard deviation of 0.024 and the distribution of $\hat{r}^2$ is also approximately normally distributed with mean of 0.91 and standard deviation of 0.0085.
